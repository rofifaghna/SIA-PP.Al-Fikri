                    ...
                    echo "<tr><td>$no</td>
                              ...
                              if (isset($_GET['tahun'])){
                                echo "<td style='width:70px !important'><center>
                                          <a class='btn btn-success btn-xs' title='Lihat Santri' href='index.php?view=raportuts&act=listsiswa&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]&tahun=$_GET[tahun]'><span class='glyphicon glyphicon-th-list'></span> Input Nilai</a>
                                        </center></td>";
                              }
