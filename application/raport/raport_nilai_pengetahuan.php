<?php 
    if (isset($_POST['simpan'])){
            if ($_POST['status']=='Update'){
              mysql_query("UPDATE rb_nilai_pengetahuan SET kd='$_POST[a]', nilai1='$_POST[b]', nilai2='$_POST[c]', nilai3='$_POST[d]', deskripsi='$_POST[g]' where id_nilai_pengetahuan='$_POST[id]'");
            }else{
              mysql_query("INSERT INTO rb_nilai_pengetahuan VALUES('','$_GET[jdwl]','$_POST[nisn]','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[g]','$_SESSION[id]','".date('Y-m-d H:i:s')."')");
            }
              ...
              <table class='table table-bordered table-striped'>
                              ...
                              while($r=mysql_fetch_array($tampil)){
                                  ...
                                  if ($_GET['nisn']==$r['nisn']){
                                    ...
                                    $ratarata = average(array($n['nilai1'],$n['nilai2'],$n['nilai3']));
                                    ...
                                    if ($cekpredikat >= 1){
                                      ...
                                      $maxn = mysql_fetch_array(mysql_query("SELECT ((nilai1+nilai2+nilai3)/3) as rata_rata, deskripsi FROM rb_nilai_pengetahuan where kodejdwl='$_GET[jdwl]' AND nisn='$r[nisn]' ORDER BY rata_rata DESC LIMIT 1"));
                                      ...
                                      echo "<tr>
                                              <td></td><td></td>
                                              <td align=center colspan='4'>Nilai Max/Min</td>
