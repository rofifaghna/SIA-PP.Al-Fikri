                                            ...
                                            JOIN rb_mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                                              JOIN rb_guru c ON a.nip=c.nip 
                                                JOIN rb_ruangan d ON a.kode_ruangan=d.kode_ruangan
                                                  ...
                                                  where a.kode_kelas='$_GET[kelas]' AND a.id_tahun_akademik='$_GET[tahun]' ORDER BY a.hari DESC");
...
<?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              if($_SESSION['level']!='kepala'){
                                echo "<td style='width:80px !important'><center>
                                        ...
                                        <a class='btn btn-danger btn-xs' title='Delete Data' href='index.php?view=journalkbm&hapus=$r[id_journal]&jdwl=$_GET[id]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                                      </center></td>";
                              }
                            echo "</tr>";
                      $no++;
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=journalkbm'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
