                ...
                <div class="box-body">
                  ...
                  <?php
                    ...
                    //                                   AND b.kode_kurikulum='$kurikulum[kode_kurikulum]' ORDER BY a.hari DESC");
                      ...
                      LEFT JOIN rb_mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                      LEFT JOIN rb_guru c ON a.nip=c.nip 
                      LEFT JOIN rb_ruangan d ON a.kode_ruangan=d.kode_ruangan
                      LEFT JOIN rb_kelas e ON a.kode_kelas=e.kode_kelas
                      LEFT JOIN rb_tahun_akademik f ON a.id_tahun_akademik=f.id_tahun_akademik  
