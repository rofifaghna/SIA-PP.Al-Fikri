              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Kapasitas Tempat Tidur</th>               <td><input type='text' class='form-control' name='e' value='$s[kapasitas_ujian]'></td></tr>
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Kapasitas Tempat Tidur</th>               <td><input type='text' class='form-control' name='e'></td></tr>
