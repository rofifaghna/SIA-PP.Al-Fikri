              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Nama Pesantren</th>   <td><input type='text' class='form-control' name='a' value='$s[nama_sekolah]'></td></tr>
                    <tr><th scope='row'>NSPP</th>                         <td><input type='text' class='form-control' name='b' value='$s[npsn]'></td></tr>
                    <tr><th scope='row'>Alamat Pesantren</th>               <td><input type='text' class='form-control' name='d' value='$s[alamat_sekolah]'></td></tr>
