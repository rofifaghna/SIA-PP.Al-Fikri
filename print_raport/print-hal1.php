...
<html>
<head>
<title>Hal 1 - Raport Santri</title>
...
<body onload="window.print()">
    <h1 align=center>RAPORT <br>PONDOK PESANTREN AL-FIKRI <br></h1><br>

    <table style='font-size:23px' width='100%'>
        <tr><td width='180px'>Nama Pondok</td>   <td width='10px'> : </td><td> <?php echo "$s[nama_sekolah]"; ?></td></tr>
        ...
        <tr><td width='180px'>Alamat Pondok</td> <td width='10px'> : </td><td> <?php echo "$s[alamat_sekolah]"; ?></td></tr>
