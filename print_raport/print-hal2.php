...
<html>
<head>
<title>Hal 2 - Raport Santri</title>
...
<body onload="window.print()">
    <h1 align=center>IDENTITAS SANTRI</h1><br>

    <table style='font-size:15px' width='100%'>
        <tr><td width='25px'>1.</td>  <td width='190px'>Nama Lengkap Santri</td>   <td width='10px'> : </td><td> <?php echo "$s[nama]"; ?></td></tr>
        ...
        <tr><td>8.</td>  <td width='190px'>Alamat Santri</td>                      <td width='10px'> : </td><td> <?php echo "$s[alamat]"; ?></td></tr>
    ...
    <table width='40%' style='float:right'>
        <tr><td>Wonosobo, <?php echo tgl_raport(date('Y-m-d')); ?> <br>
                Pengasuh,<br><br><br><br>


                <b>Dr. K. H. Mahfudz Junaedi, M.H</b></td></tr>
    </table>
</body>
</html>