  ...
  if (isset($_SESSION['id'])){
      if ($_SESSION['level']=='superuser'){
          $iden = mysql_fetch_array(mysql_query("SELECT * FROM rb_users where id_user='$_SESSION[id]'"));
           ...
           $level = 'Administrator';
           $foto = 'dist/img/user2-160x 160.jpg';
...
<html>
  <head>
    ...
    <title>SIA PonPes Al-Fikri</title>
      ...
      <div class="content-wrapper">
        ...
        <?php 
          ...
          elseif ($_GET['view']=='sms'){
            ...
            echo "</div>";
          }elseif ($_GET['view']=='kritik_saran'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_kritik_saran.php";
            echo "</div>";
          }
        ?>
        </section>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Berikan Santri Nilai Essai</h4>
          </div>
