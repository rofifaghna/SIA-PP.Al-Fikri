...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="index.php" class="navbar-brand">
        ...
        <span class="brand-text font-weight-light">SIA PP Al-Fikri</span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="application/awal/kritik_saran.php" class="nav-link">
            <i class="nav-icon fas fa-edit"></i>
            Kritik Dan Saran
            </a>
          </li>
          <li class="nav-item">
            <a href="https://www.omahngaji.com" class="nav-link">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="dist/img/omahngaji.jpeg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Omah Ngaji</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Login <small>Home Page</small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="post text">
      ...
      <div class="container">
            <div class="row justify-content-md-center">
              <?php include "application/awal/sidebar.php";?>
            </div>
      </div>
