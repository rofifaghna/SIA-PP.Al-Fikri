    ...
    .pondok:hover{
      color:#fff;
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-lg"><b>SIA PP AL-FIKRI</b></span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li><a <?php 
                        if ($_SESSION['level']=='superuser'){
                            echo "<a href='index.php?view=admin&act=edit&id=$_SESSION[id]' class='btn btn-success'>Edit Profile</a>";
                        }elseif($_SESSION['level']=='kepala'){
                            echo "<a href='index.php?view=admin&act=edit&id=$_SESSION[id]' class='btn btn-success'>Edit Profile</a>";    
                        }elseif($_SESSION['level']=='guru'){
                            echo "<a href='index.php?view=guru&act=detailguru&id=$_SESSION[id]' class='btn btn-success'>View Profile</a>";
                        }elseif($_SESSION['level']=='siswa'){
                            echo "<a href='index.php?view=siswa&act=detailsiswa&id=$_SESSION[id]' class='btn btn-success'>View Profile</a>";
                        }
                      ?> </a>
              </li>
