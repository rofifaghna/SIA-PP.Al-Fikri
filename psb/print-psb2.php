...
<?php
    ...
    $s = mysql_fetch_array($detail);
            echo "<h3><center>PONDOK PESANTREN AL-FIKRI <br> DATA-DATA SANTRI OMAH NGAJI</center></h3>
                  <table width='100%'>
                      <tr><td colspan='3'>1. Nama Santri</td></tr>
...
<table border=0 width=100%>
  <tr>
    ...
    <td width="400" align="center">Wonosobo, <?php echo tgl_raport(date("Y-m-d")); ?> <br> Mengetahui: orang tua / wali</td>
  </tr>
  <tr>
