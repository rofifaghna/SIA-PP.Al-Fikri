...
?>
<head>
<title>Data Penerimaan Santri Baru</title>
...
<?php
    ...
    $s = mysql_fetch_array($detail);
            echo "<table width=100%>
                      <tr><td width='90px'><img style='width:80px' src='dist/img/omahngaji.jpeg'>
                          </td><td><b>$status PONDOK PESANTREN <br> OMAH NGAJI AL-FIKRI </b><br> Jl. Jawar Jl. Mekarsari No.3, Jambean, Kalibeber, Kec. Mojotengah, Kabupaten Wonosobo, Jawa Tengah 56351</td></tr>
                  </table><hr>";
            echo "<h3><center>FORMULIR PENDAFTARAN <br>DATA SANTRI</center></h3>
                  <table width='100%'>
...
?>
Saya yang bertanda tangan dibawah ini , mendaftarkan anak saya sebagai santri/santriwati dan bersedia mengikuti persyaratan dan peraturan yang berlaku.
<br>
<table border=0 width=100%>
  <tr>
    <td width="400" align="left"><br>Wonosobo, <?php echo tgl_raport(date("Y-m-d")); ?></td>
  </tr>
  <tr>
    <td align="left"><br /><br />
      ................................... </td>
