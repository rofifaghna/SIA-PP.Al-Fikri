...
<html>
<head>
<title>Print Kartu Pendaftaran Santri</title>
<link rel="stylesheet" href="bootstrap/css/printer.css">
</head>
<body onload="window.print()">
<table style='border:1px solid #000' border='0' width='100%'>
  <tr>
    <td width=120px><img style='width:90px; margin-top:7px' src='dist/img/omahngaji.jpeg'></td>
    <td><center>KARTU AKTIVASI PENDAFTARAN<br> PSB PONDOK PESANTREN AL-FIKRI</center></td>
    <td width=120px></td>
  </tr>
</table>
...
<tr><td>- Pendaftaran di alamat <span style='color:blue; text-decoration:underline'>http://omahngaji.com</span></td></tr>
...
<tr><td>- Jika ada kendala lainnya bisa kontak kami di email. <span style='color:blue; text-decoration:underline'><?php echo "omahngaji21@gmail.com"; ?></span></td></tr>
</table>
</body>
</html>